# Node.js : Environment Variables <img valign="bottom" align="right" height="40px" widht="40px" src="https://nodejs.org/static/images/logos/nodejs-new-pantone-black.png" />


### What is in there
This GitHub repository is just a simple starter application using environment variables.
...
### How to make it run
```
git clone https://github.com/mustapha-benmbarek/nodejs-env-variable
cd nodejs-env-variable
npm install
node index.js
```
